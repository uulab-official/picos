...
- Config workspace: `j/k` selects retention controls, `+/-` adjusts and persists `auditArchiveRetentionLimit` or `toolTargetPresetLimit`, and `enter` logs the current config path and active retention values
- `d`: run doctor
