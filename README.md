...
- Palette-triggered `trail source` cycles also append Status Activity result history rows with the selected source filter and visible/total recovered trail count
