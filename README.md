...
- Timeline with network/action/audit/raw event filters, search presets, visible selected-row cursor, locked selected-event copy, selected-row audit export, Status audit export index/open controls, scoped audit export, latest audit reload, and network state-change events
