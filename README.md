...
- Routes workspace: `f` filters route rows, `F` clears the filter, `Tab` cycles table/raw/diagnostics/path panes, `s` cycles route row sorting, and `:` opens destination path lookup
