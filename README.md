...
- Config workspace: `j/k` selects config rows, `+/-` adjusts and persists numeric, language, boolean, and dry-run policy values, `enter` edits `defaultPingHost` or logs the current config path and active values
- `d`: run doctor
