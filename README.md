...
- Interfaces workspace: `j/k` selects interfaces and `Tab` cycles list/detail/stats/platform source panes; every pane keeps a selected-interface strip visible with group, primary marker, IPv4/IPv6, MAC/netmask, MTU, RX/TX counters, gateway, DNS, public IP, platform source, and safe action hints
