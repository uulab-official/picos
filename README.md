...
- Tools Hub with read-only DNS/RDAP/IP/TCP/TLS/ping/traceroute commands, target prompts, selectable result history, rerun, locked raw-output copy, and raw output handoff
