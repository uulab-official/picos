...
function RemotesWorkspace({
	...
	const hostKeyEvidenceResultRows = formatRemoteHostKeyEvidenceResultRows(
		createRemoteHostKeyEvidenceResult(selectedProfile),
	);
	...
	return (
		<Box flexDirection="column">
			...
			<Box marginTop={1} flexDirection="column">
				<Text color="cyan">HOST KEY EVIDENCE RESULT</Text>
				{hostKeyEvidenceResultRows.map((row) => (
					<Text
						key={row}
						color={
							row.startsWith("REMOTE")
