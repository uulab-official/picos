...
Result: Draft PR [#369](https://github.com/uulab-official/picos/pull/369) opened on 2026-07-02, stacked on `codex/picos-v0.4.295-sftp-package-resolution-review`.
